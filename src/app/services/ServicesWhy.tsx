...
export default function ServicesWhy() {
  return (
    <section className="px-4 md:px-8 py-12 md:pt-[80px] md:pb-[120px] bg-white">
      ...
      <div className="flex flex-col gap-5 md:max-w-[662px] md:mx-auto">
        ...
        <p className="font-light italic text-[24px] md:text-[35px] tracking-[-0.04em] leading-[1.25] text-[#1f1f1f] py-3 md:py-[40px]">
          {pullQuote}
        </p>
