...
/*
  PROJECTS TAGLINE
  ────────────────
  Same staircase word-fill animation as BioSection (home page second section).
  Five lines of copy cascade at varying horizontal indents on desktop.
  Words fill from light grey to black as the section scrolls through the viewport.
  Sits directly under the fixed navbar — top padding accounts for navbar height.
*/
...
export default function ProjectsTagline() {
  ...
  return (
    <section
      ref={sectionRef}
      className="px-4 md:px-8 py-12 md:py-[120px] bg-white"
    >
      <div className="flex flex-col gap-6 w-full">

        {/* Header: label + rule (right-aligned, same as BioSection) */}
        ...
        <div className="flex flex-col gap-2 w-full">
          ...
          <div className="flex flex-col items-center gap-3 md:flex-row md:items-start md:gap-3 uppercase">
            ...
            <p className="order-last md:order-first font-light text-[32px] md:text-[6.67vw] tracking-[-0.08em] leading-[0.84] whitespace-pre">
              <Words text="The work" />{'   '}<span data-word className="inline-block">/</span>
            </p>
          </div>
